  ...
  return (
    <div className='flex flex-initial w-44 flex-col p-4 m-2 border-2 border-black rounded-lg'>
      <p>
        ...
        dolorum quas voluptates delectus. Neque tempore accusantium repellat quo
        laboriosam velit ea facere placeat repudiandae sequi voluptas illum
        possimus impedit vero doloremque amet quidem, enim totam inventore
