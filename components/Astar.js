...
import { aStar, aStarStep } from "../scripts/aStar";
...
export default class Astar extends Component {
    ...
    next() {
        let { visitedNodesInOrder, grid, openList, closedList } = this.state;

        if (openList.length > 0) {
            var currentNode = aStarStep(
                grid,
                visitedNodesInOrder,
                openList,
                closedList,
            ...
            if (!currentNode.isWall) {
                ...
                this.setState({ grid, visitedNodesInOrder, openList, closedList });
    ...
    randomize() {
        ...
        // Test end
        this.setState({ grid, openList, closedList, visitedNodesInOrder });
        this.props.mazeSetter(grid);
    }
    ...
    render() {
        ...
        return ( <
            ...
            <
            button className = " p-4 text-lg mt-2 shadow-md hover:shadow-xl hover:bg-red-600 bg-red-500 text-white rounded-md"
            onClick = {
                () => this.visualizeAstar() } >
            Play <
            /button>
            ...
            <
            button className = " p-4 text-md mt-2 shadow-md hover:shadow-xl hover:bg-gray-700 bg-black text-white rounded-md"
            onClick = {
                () => this.next() } >
            Next <
            /button>
            ...
            <
            button className = " p-4 text-md mt-2 shadow-md hover:shadow-xl hover:bg-red-700 bg-red-600 text-white rounded-md"
            onClick = {
                () => this.randomize() } >
            Random Maze <
            /button>
